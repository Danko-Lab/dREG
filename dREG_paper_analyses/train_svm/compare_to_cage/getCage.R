require(bigWig)
require(dREG)
setwd("/bscb/bscb07/cgd24/home/work/tss_detector/validation/ext_files")

signal_threshold <- 8 ## Andre chose a threshold of 8 for both K562 and GM12878.

pap_p <- "/bscb/bscb07/cgd24/data/hg19/k562/cage_bp/riken_cage_nucleus_pap_plus.bigWig"
pap_m <- "/bscb/bscb07/cgd24/data/hg19/k562/cage_bp/riken_cage_nucleus_pap_minus.bigWig"
#pap_p <- "/bscb/bscb07/cgd24/data/hg19/gm12878/cage_bp/riken_cage_nucleus_pap_plus.bigWig"
#pap_m <- "/bscb/bscb07/cgd24/data/hg19/gm12878/cage_bp/riken_cage_nucleus_pap_minus.bigWig"
