...
## Read PRO-seq data.
ps_plus_path  <- "groseq_plus.bigWig"
ps_minus_path <- "groseq_minus.bigWig"
...
write.table(final_data, file="k562_small.predictions.bedGraph", row.names=FALSE, col.names=FALSE, quote=FALSE, sep="\t")
