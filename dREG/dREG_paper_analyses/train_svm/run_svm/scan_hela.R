...
## Read PRO-seq data.
ps_plus_path  <- "HeLa.combined_plus.bw"
ps_minus_path <- "HeLa.combined_minus.bw"
...
write.table(final_data, file="hela.predictions.bedGraph", row.names=FALSE, col.names=FALSE, quote=FALSE, sep="\t")
