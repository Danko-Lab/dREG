...
adbn <- regulatory_dbn(gdmm, adbn, ps_plus_path, ps_minus_path, inf_positions, dnase, n_train=100000, n_eval=0, extra_enrich_bed= extra_enrich_bed, allow= allow_bed)

remove(inf_positions, ps_plus_path, ps_minus_path, extra_enrich_bed, allow_bed)
save.image("dnase1..adbn.RData")
