...
ntb7 <- read.table("../new-model-201709/G7/out.dREG.infp.bed.gz")
...
ntb.GM <- read.table("../new-model-201709/GM12878/out.dREG.infp.bed.gz")
...
pred_bed_list <- list(otb7, ntb7, otb.GM, ntb.GM);
pred_bed_cols <- c("#c45ca2", "#c45ca2", "#60a862", "#60a862");
pred_bed_cex <- c(0.25, 1, 0.25, 1);
...
lengend_data  <- c("K562 by old model", "K562 by new model", "GM12878 by old model", "GM12878 by new model");
lengend_lwd <- c(NA, NA, NA, NA);
lengend_lty <- c(NA, NA, NA, NA);
lengend_pch <- c(19, 19, 19, 19);
lengend_cols <- c("#c45ca2", "#c45ca2", "#60a862", "#60a862");
lengend_cex <- c(0.5, 1,  0.5, 1);
